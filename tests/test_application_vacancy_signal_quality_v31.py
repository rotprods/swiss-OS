...
from swiss_os.vacancy_signal_quality import semantic_quality, temporal_quality
...
class VacancySignalQualityV31Tests(unittest.TestCase):
    ...
    def test_date_only_valid_through_is_valid_for_entire_day(self):
        signal = {
            "title": "Housekeeping Attendant",
            "date_posted": "2026-08-01",
            "valid_through": "2026-08-31",
            "source_url": "https://example.com/jobs/housekeeping",
            "evidence_type": "CURRENT_STRUCTURED_JOBPOSTING",
        }
        quality = temporal_quality(signal, "2026-08-31T20:31:55Z")
        self.assertTrue(quality["current"])
