...
ART = ROOT / "docs/state/SRR_CURRENT_IDENTITY_EVIDENCE_500599_P1_B02_2026-08-30.json"
...
def test_p1_b02_is_exact_evidence_bound_and_fail_closed():
    ...
    assert art["batch"]["batch_id"] == "P1-B02"
    ...
    assert art["band_frontier"]["reviewed_after"] == 30
    assert art["band_frontier"]["remaining_after"] == 16
    assert art["cumulative_preauthority_frontier"]["total_new_canonical_preauth"] == 49
    ...
    assert nxt["next_route"] == "EXECUTE_500599_P1_B03_CURRENT_IDENTITY_REVIEW_WITHOUT_AUTOBIND"
    assert nxt["review_frontier"]["band500599"]["reviewed_after"] == 30
    assert nxt["review_frontier"]["band500599"]["remaining"] == 16
