...
EVENT_SCHEMA="COS-V2-EVENT-1.0"; CLAIM_SCHEMA="COS-V2-CLAIM-1.0"; CONTEXT_SCHEMA="COS-V2-CONTEXT-PACK-1.0"; PROJECT_STATE_SCHEMA="COS-V2-PROJECT-STATE-1.0"
...
def build_context_pack(*,project_id,main_sha,authority_revision,projection,state_refs,blockers,next_safe_actions):
    if not _is_git_sha(main_sha): raise CoordinationError("main_sha must be lowercase 40-hex Git object ID")
