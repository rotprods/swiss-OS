...
class MetaExecutionTests(unittest.TestCase):
    ...
    def test_directory_manifest_is_independent_fallback_without_api_capture(self) -> None:
        decision = choose_meta_route(
            MetaCapabilities(
    ...
    def test_unresolved_records_route_to_exact_current_refresh_after_manifest_complete(self) -> None:
        decision = choose_meta_route(
            MetaCapabilities(
                member_directory_manifest_complete=True,
