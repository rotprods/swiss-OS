...
class RAGR34B03Tests(unittest.TestCase):
    def test_exact_batch_classification_and_safety(self):
        ...
        self.assertEqual(art["decisions_sha256"], "7b8fc2e08734d63ef6603510cfdb627dd78fecb0121fa65d7f342b8d03a84d27")
        self.assertTrue(all(d["classification"] == "IN_SCOPE_NO_SOURCE_MATCH" for d in decisions))
    ...
    def test_next_advances_to_final_b04(self):
        ...
        self.assertEqual(ragr["classification_counts"]["IN_SCOPE_NO_SOURCE_MATCH"], 23)
