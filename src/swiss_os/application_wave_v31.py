...
from .application_wave import (
    EVIDENCE_PRIORITY,
    _validate_market_aggregate,
    _validate_market_record,
    role_accessibility_score,
    vacancy_priority,
)
...
def compile_top_resolved_vacancy_seeds_v31(
    ...
    *,
    ...
    Rejects navigation labels, temporally contradictory/expired structured postings and
    cross-property duplicate vacancy identities. A duplicate vacancy URL+title observed
    under multiple source hotels is preserved in an ownership-review queue rather than
    multiplied into several property applications.
    """
    ...
    for detail_record in vacancy_detail.get("records") or []:
        ...
        _validate_market_record(market_record)
        ...
        primary.append(
            {
                ...
                "vacancy_priority": _candidate_priority(best),
